...
<body>
    ...
    <main>
        <div class="mt-5 container">
            <h1><b><i class="fa-solid fa-bullhorn"></i> เพิ่มหมวดหมู่หนังสือ</b></h1>

            <form action="./process/add-catagory.php" method="post" enctype="multipart/form-data">
                <h3 class="mt-3">ชื่อหมวดหมู่</h3>
                <input type="text" class="form-control w-100" placeholder="หมวหมู่" name="catagory">
