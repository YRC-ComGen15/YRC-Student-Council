...
<body>
    ...
    <main>
        <div class="mt-5 container">
            ...
            <form action="./process/edit-project.php" name="form" method="post" enctype="multipart/form-data">
                <h3 class="mt-3">id</h3>
                ...
                <?php if (!empty($data['icon'])) : ?>
                    <img id="preview" src="../uploads/<?php echo $data['icon']; ?>" alt="Icon Preview" class="img-thumbnail" width="100">
                <?php else : ?>
                    <img id="preview" src="https://via.placeholder.com/100" alt="Icon Preview" class="img-thumbnail" width="100">
                <?php endif; ?>

                <input type="file" class="form-control w-100 mt-2" name="icon" accept="image/*" onchange="previewImage(event)">
                <input type="hidden" name="existing_icon" value="<?php echo $data['icon']; ?>">
