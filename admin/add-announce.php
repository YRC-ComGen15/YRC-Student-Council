...
<body>
    ...
    <main>
        <div class="mt-5 container">
            ...
            <form action="./process/add-announce.php" method="post" enctype="multipart/form-data">
                ...
                <textarea name="decp" class="form-control w-100" placeholder="รายละเอียดข่าวประชาสัมพันธ์"></textarea>
