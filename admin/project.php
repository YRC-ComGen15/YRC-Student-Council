...
<head>
    ...
    <title>จัดการโครงการ - SCA admin</title>
...
<body>
    ...
    <main>
        <div class="mt-5 container">
            <h1><b><i class="fa-solid fa-bullhorn"></i> จัดการโครงการสภานักเรียน</b></h1>

            <a href="./add-project.php" class="btn btn-outline-success">เพิ่มโครงการ + </a>
                    ...
                    <tbody>
                        ...
                        <?php while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) { ?>
                            <tr>
                                ...
                                <td class="d-flex">
                                    <a href="./edit-project.php?id=<?php echo $row['id'] ?>    " class="btn btn-primary m-auto"><i class="fa-solid fa-pencil"></i> edit</a>
                                    <a href="./process/del-project.php?id=<?php echo $row['id'] ?>    " class="btn btn-danger m-auto"><i class="fa-solid fa-pencil"></i> delete</a>
                                </td>
                            </tr>
                        <?php } ?>
